...
import {
  ...
  setTopInvoiceEntity,
  getTopInvoiceEntity,
  editPaymentCustomerRemark,
  editPaymentCustomerPayDay,
  getPaymentTrackCustomers,
  deletePaymentTrackAttachment,
...
const useSystemStore = defineStore('system', {
  ...
  actions: {
    ...
    async deletePageByIdAction(pageName, id, options = {}) {
      ...
      if (deleteResult && deleteResult.code !== undefined && deleteResult.code !== 0) {
    ...
    async newPageDataAction(pageName, pageInfo, listType = 'list') {
      try {
        ...
        await this.postPageListAction(pageName, null, listType)
    ...
    async editPaymentCustomerRemarkAction(id, remarkInfo) {
      const editResult = await editPaymentCustomerRemark(id, remarkInfo)
    ...
    async editPaymentCustomerPayDayAction(id, dayInfo) {
      const editResult = await editPaymentCustomerPayDay(id, dayInfo)
    ...
    async getPaymentTrackCustomersAction() {
      const result = await getPaymentTrackCustomers()
      return result.data.list
    },


    async deletePaymentTrackAttachmentAction(id) {
      await deletePaymentTrackAttachment(id)
    },


    async deletePaymentTrackVoucherAction(id) {
      await deletePaymentTrackVoucher(id)
    },


    async getPaymentTrackEntityOptionsAction() {
      const result = await getPaymentTrackEntityOptions()
      return result.data.list
    },


    async getPaymentTrackCurrencyOptionsAction() {
      const result = await getPaymentTrackCurrencyOptions()
      return result.data.list
    },
