  ...
  <div class="google-content">
    ...
    <div class="page-header">
      <div class="header-left">
        <h1 class="page-title">LP点击</h1>
        <p class="page-subtitle">system_lp_clicks · LP → Offer 点击</p>
      </div>
      <div class="header-actions">
        <el-popover
          ...
          :width="260"
          popper-class="lp-clicks-col-popover"
    ...
    <div class="content-card">
      ...
      <div class="table-wrapper">
        <el-table :data="tableData" v-loading="loading" class="google-table" :border="false" :tooltip-options="{ popperClass: 'lp-clicks-overflow-tooltip' }">
...
import { getLpClicks } from '@/services/main/ef-tracker'
...
const DEFAULT_COLUMNS = [
  ...
  { key: 'names.media', label: '媒体', type: 'names', nameKey: 'media', prop: 'names.media', minWidth: 110, overflow: true },
  { key: 'names.tracker', label: 'Tracker', type: 'names', nameKey: 'tracker', prop: 'names.tracker', minWidth: 110, overflow: true },
  { key: 'names.lander', label: '落地页', type: 'names', nameKey: 'lander', prop: 'names.lander', minWidth: 110, overflow: true },
  { key: 'names.offer', label: 'Offer', type: 'names', nameKey: 'offer', prop: 'names.offer', minWidth: 110, overflow: true },
  { key: 'path_code', label: 'path_code', type: 'plain', prop: 'path_code', width: 100, overflow: true },
  { key: 'ip', label: 'ip', type: 'plain', prop: 'ip_address', width: 120, overflow: true, defaultHidden: true },
  { key: 'referer', label: 'referer', type: 'plain', prop: 'referer', minWidth: 180, overflow: true, defaultHidden: true },
  { key: 'offer_url', label: 'offer_url', type: 'plain', prop: 'offer_url', minWidth: 220, overflow: true }
]
...
async function loadData() {
  loading.value = true
  try {
    const result = await getLpClicks(buildParams())
...
<style>
/* el-table 溢出 tooltip（已传送到 body，scoped 选不中）：限制最大宽度，避免 media_click_id / offer_url 等长文本超出屏幕 */
.lp-clicks-overflow-tooltip {
  max-width: 400px;
  word-break: break-all;
}

/* 列配置面板（el-popover teleported 到 body，scoped 选不中，写在全局） */
.lp-clicks-col-popover.el-popper {
  padding: 0 !important;
}
