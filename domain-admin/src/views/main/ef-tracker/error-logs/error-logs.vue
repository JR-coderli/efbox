  ...
  <div class="google-content">
    ...
    <div class="page-header">
      <div class="header-left">
        ...
        <p class="page-subtitle">system_error_logs · 系统错误日志</p>
      </div>
    ...
    <div class="content-card">
      ...
      <div class="table-wrapper">
        <el-table :data="tableData" v-loading="loading" class="google-table" :border="false" :tooltip-options="{ popperClass: 'error-logs-overflow-tooltip' }">
          ...
          <el-table-column label="error_reason" prop="error_reason" min-width="180" show-overflow-tooltip />
          <el-table-column label="endpoint" prop="endpoint" min-width="160" show-overflow-tooltip />
          <el-table-column label="method" prop="request_method" width="80" align="center" />
...
import { getErrorLogs } from '@/services/main/ef-tracker'
